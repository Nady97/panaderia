...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $permissionGates = [
            ...
            'notas_compra.edit',
            'notas_compra.delete',
            'facturas_internas.view',
            'facturas_internas.create',
            'facturas_internas.edit',
            'facturas_internas.delete',
            'facturas_internas.download',
            'solicitudes_produccion.view',
            'solicitudes_produccion.create',
            'solicitudes_produccion.approve',
            'perfil.edit',
            'perfil.password',
            'perfil.delete',
        ];
