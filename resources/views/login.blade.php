...
<head>
    ...
    <title>Login - ERP Panadería Artesanal</title>
    ...
    <div class="container-fluid flex-grow-1 d-flex p-0 m-0">
        <div class="row g-0 w-100">
            ...
            <div class="col-lg-6 d-none d-lg-flex flex-column justify-content-center align-items-center login-showcase text-white p-5 text-center">
                ...
                <h1 class="display-4 fw-bold mb-3">Panadería Artesanal</h1>
                ...
                <div class="w-100" style="max-width: 420px;">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-5">
                            ...
                            <a href="{{ route('password.request') }}" class="text-decoration-none text-gold fw-medium">¿Olvidaste tu clave?</a>
                        </div>
