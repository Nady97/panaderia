...
{{-- 
    -----------------------------------------------------------------------
    ARCHIVO: resources/views/recetas/create.blade.php
    PROPÓSITO: Formulario para la creación de una nueva Receta.
            ...
            <form method="POST" action="{{ route('recetas.store') }}" id="formCrearReceta">
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-md-6 form-group">
                        <x-input name="nombre" label="Nombre de la Fórmula/Receta" required="true" icon='<i class="bi bi-journal-text"></i>' value="{{ old('nombre') }}" placeholder="Ej: Masa Madre Blanca 20h..." />
                    </div>
                ...
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-md-4 form-group">
                        <x-input type="number" step="0.01" name="rendimiento_estimado" label="Rendimiento Esperado" required="true" icon='<span class="fw-bold" style="font-size: 0.85rem">Unid/Kg</span>' value="{{ old('rendimiento_estimado') }}" placeholder="Ej: 50.00" />
                        <div class="form-text mt-1 text-muted" style="margin-top: -15px !important;"><i class="bi bi-lightbulb me-1"></i> Producción final estimada.</div>
                    </div>

                    <!-- Tiempo de Preparación -->
                    <div class="col-md-4 form-group">
                        <x-input type="number" name="tiempo_preparacion_min" label="Tiempo de Ciclo" required="true" icon='<i class="bi bi-clock-history"></i>' value="{{ old('tiempo_preparacion_min') }}" placeholder="Minutos (Ej: 120)" />
                    </div>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-12 form-group">
                        <x-textarea name="instrucciones" label="Instrucciones de Elaboración / Amasado" rows="5" icon='<i class="bi bi-card-text"></i>' placeholder="1. Autólisis 30 min.&#10;2. Amasado de primera marcha...&#10;3. Fermentación en bloque..." value="{{ old('instrucciones') }}" />
                    </div>
                </div>
